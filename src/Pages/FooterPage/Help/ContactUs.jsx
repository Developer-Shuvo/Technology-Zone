...
const ContactUs = () => {
  return (
    <div class="sm:p-10 my-auto">
      <section class="mx-auto max-w-[1300px] mt-10 mb-30 px-4 border-gray-300 md:rounded-md md:border md:shadow-lg">
        <div class="grid grid-cols-4 text-gray-800 lg:grid-cols-3">
          <div class="col-span-4 bg-sky-50 px-8 py-10 text-gray-800 md:col-span-2 md:border-r-2  border-gray-400  md:px-10 md:py-12 lg:col-span-1">
            <h2 class="mb-8 text-2xl font-bold text-gray-800">Contact Us</h2>
            <ul>
              ...
              <li class="my-6 flex items-center text-left">
                ...
                <div>
                  <p class="font-serif text-base md:text-lg">technology zone</p>
          ...
          <div class="order-first col-span-4 max-w-screen-md px-8 py-10 md:order-last md:col-span-2 md:px-10 md:py-12">
            <h2 class="mb-8 text-3xl text-gray-800 font-bold">Get in touch</h2>
            ...
            <form action="">
              <div class="md:col-gap-4 mb-5 grid md:grid-cols-2">
                <input
                  class="col-span-1 w-full border-b border-gray-400 py-3 text-sm outline-none focus:border-b-2 focus:border-black"
                  type="text"
                  placeholder="Name"
                  name="name"
                />
              ...
              <textarea
                class="mb-10 w-full resize-y whitespace-pre-wrap border-b border-gray-400 py-3 text-sm outline-none focus:border-b-2 focus:border-black"
                id=""
                rows="6"
              ...
              <button
                type="submit"
                class="group flex cursor-pointer items-center rounded-xl bg-blue-600 bg-none px-8 py-4 text-center font-semibold leading-tight text-white"
              >
                Send
                <svg
