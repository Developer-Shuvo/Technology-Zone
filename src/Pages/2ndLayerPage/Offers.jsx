...
const Offers = () => {
  ...
  <div className="bg-[#C2EFD4] mx-auto max-w-[1400px] w-full px-4 sm:px-6 md:px-10 relative flex flex-col-reverse lg:flex-row justify-around items-center gap-12 lg:gap-20 rounded-xl shadow-lg overflow-hidden">
    ...
    {/* Image */}
    <img
      className="w-full max-w-[600px] h-auto object-cover rounded-lg shadow-xl hover:scale-105 transition-transform duration-500"
    ...
    <div className="w-full max-w-[589px] px-4 sm:px-0">
      <h2 className="text-[#224f34] text-[30px] sm:text-[36px] md:text-[46px] mt-6 font-bold font-['Roboto_Slab'] text-center lg:text-left leading-tight drop-shadow-sm">
        Exclusive offer
      </h2>

      <p className="text-[#224f34] text-[16px] sm:text-[18px] md:text-[22px] font-medium font-['Poppins'] leading-8 mt-4 text-center lg:text-left opacity-90">
        Unlock the ultimate style upgrade with our exclusive offer. Enjoy
        savings of up to <span className="font-bold text-[#1e3a28]">40% off</span> on our latest New Arrivals
      </p>
